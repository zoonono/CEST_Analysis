...
t1.String = { date,...
             ...
             ['fasted: ', input.fasted],...
             ['# baseline scans: ', num2str(input.number_of_baselines)],...
             ['# post admin. scans: ', num2str(input.number_of_post_inj_scans)],...
             ['# ppm values: ', num2str(cest_scan(1).number_of_ppm_values)],...
...
for i_time = 1: input.number_of_scans
...
print('-bestfit',[num2str(input.number_of_scans), 'scans_', ...
